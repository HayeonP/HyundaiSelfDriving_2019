...
namespace vcsAgent
{
    class vAgent
    {
        protected:
            ...
            ros::Subscriber mm_estop_sub;
            ros::Subscriber om_estop_sub;
            ros::Subscriber score_sub;
            ros::Subscriber tunnel_sub;
            ros::NodeHandle nh;
	    ...
	    bool w_smoothing = false;
            ...
            void mission_mgr_estopCallback(const std_msgs::BoolConstPtr& msg);
            void obj_mgr_estopCallback(const std_msgs::BoolConstPtr& msg);
            void scoreCallback(const autoware_msgs::NDTStatConstPtr& msg);
            void tunnelCallback(const std_msgs::BoolConstPtr& msg);
