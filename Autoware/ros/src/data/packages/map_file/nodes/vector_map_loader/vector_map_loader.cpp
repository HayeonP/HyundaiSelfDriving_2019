...
int main(int argc, char **argv)
{
  ...
  ros::Publisher vector_map_loader_ok_pub = nh.advertise<std_msgs::Bool>("/vector_map_loader_ok", 1, true);
  std_msgs::Bool vector_map_loader_ok_msg;
  vector_map_loader_ok_msg.data = false;
  vector_map_loader_ok_pub.publish(vector_map_loader_ok_msg);
  ...
  //ICHTHUS: Debugging topic publishing
  vector_map_loader_ok_msg.data = true;
  vector_map_loader_ok_pub.publish(vector_map_loader_ok_msg);
