...
ros::Publisher points_map_loader_ok_pub;
std_msgs::Bool points_map_loader_ok_msg;
...
int main(int argc, char **argv)
{
	...
	//ICHTHUS: Debugging topic publishing
	points_map_loader_ok_pub = n.advertise<std_msgs::Bool>("/points_map_loader_ok", 1, true);
	points_map_loader_ok_msg.data = false;
	points_map_loader_ok_pub.publish(points_map_loader_ok_msg);
	...
	//ICHTHUS: Debugging topic publishing
	points_map_loader_ok_msg.data = true;
	points_map_loader_ok_pub.publish(points_map_loader_ok_msg);
