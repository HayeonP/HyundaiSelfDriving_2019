...
#include "packet.h"
#include "nodelet_lidar_driver/VLP16.h"
#include "nodelet_lidar_driver/OSI64.h"
...
namespace VLP16 {
  ...
  // void add_VLP16_msg_to_cloud(const nodelet_lidar_driver::VLP16 &msg, pcl::PointCloud<PointXYZIR>& cloud);
  void batch_VLP16_msg_to_cloud(const std::vector<nodelet_lidar_driver::VLP16::ConstPtr> &vector_msg, pcl::PointCloud<PointXYZIR>& cloud);
}
