...
std::shared_ptr<client> init_client(const std::string& hostname,
    ...
    std::cout << "do_cmd : lidar_port" << success << std::endl;

    success &= do_cmd("set_udp_port_lidar", std::to_string(lidar_port));
    std::cout << "do_cmd : udp_port" << success << std::endl;
    
    success &= do_cmd("set_udp_port_imu", std::to_string(imu_port));
    
    success &= do_cmd("set_udp_ip", udp_dest_host);
    std::cout << "do_cmd : udp_ip" << success << std::endl;
    ...
    std::cout<<"lidar_fd" << lidar_fd <<std::endl;
    int imu_fd = udp_data_socket(imu_port);
    std::cout<<"imu_fd" << imu_fd <<std::endl;
