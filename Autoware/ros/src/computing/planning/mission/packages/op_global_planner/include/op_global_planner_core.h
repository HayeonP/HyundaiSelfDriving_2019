...
#include <std_msgs/Bool.h> //ICHTHUS: Debugging topic publishing
...
protected:
	...
	std_msgs::Bool op_global_planner_ok_msg; //ICHTHUS: Debugging topic publishing
	...
	ros::Publisher op_global_planner_ok_pub; //ICHTHUS: Debugging topic publishing
