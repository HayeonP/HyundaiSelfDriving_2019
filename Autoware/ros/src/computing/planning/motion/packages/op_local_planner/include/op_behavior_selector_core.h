...
protected: //Planning Related variables
	...
	ros::Publisher op_behavior_selector_ok_pub;
	std_msgs::Bool op_behavior_selector_ok_msg;
	...
	ros::Subscriber sub_max_velocity; //ICHTHUS: max velocity topic for velocity profiling
	...
	void callbackGetMaxVelocity(const std_msgs::Float32ConstPtr &msg); //ICHTHUS: max velocity topic for velocity profiling
