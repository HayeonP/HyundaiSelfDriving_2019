...
// (in-package object_manager_msgs.msg)
...
class combined {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('bb_ary')) {
        this.bb_ary = initObj.bb_ary
      }
      else {
        this.bb_ary = new jsk_recognition_msgs.msg.BoundingBoxArray();
      }
      if (initObj.hasOwnProperty('obj_ary')) {
        this.obj_ary = initObj.obj_ary
      }
      else {
        this.obj_ary = new autoware_msgs.msg.DetectedObjectArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type combined
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [bb_ary]
    bufferOffset = jsk_recognition_msgs.msg.BoundingBoxArray.serialize(obj.bb_ary, buffer, bufferOffset);
    // Serialize message field [obj_ary]
    bufferOffset = autoware_msgs.msg.DetectedObjectArray.serialize(obj.obj_ary, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type combined
    let len;
    let data = new combined(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [bb_ary]
    data.bb_ary = jsk_recognition_msgs.msg.BoundingBoxArray.deserialize(buffer, bufferOffset);
    // Deserialize message field [obj_ary]
    data.obj_ary = autoware_msgs.msg.DetectedObjectArray.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += jsk_recognition_msgs.msg.BoundingBoxArray.getMessageSize(object.bb_ary);
    length += autoware_msgs.msg.DetectedObjectArray.getMessageSize(object.obj_ary);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'object_manager_msgs/combined';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '0913eb20e42983a953910130fae82640';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new combined(null);
    ...
    if (msg.bb_ary !== undefined) {
      resolved.bb_ary = jsk_recognition_msgs.msg.BoundingBoxArray.Resolve(msg.bb_ary)
    }
    else {
      resolved.bb_ary = new jsk_recognition_msgs.msg.BoundingBoxArray()
    }

    if (msg.obj_ary !== undefined) {
      resolved.obj_ary = autoware_msgs.msg.DetectedObjectArray.Resolve(msg.obj_ary)
    }
    else {
      resolved.obj_ary = new autoware_msgs.msg.DetectedObjectArray()
    }
