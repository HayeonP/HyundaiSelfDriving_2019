...
asn_TYPE_member_t asn_MBR_NodeOffsetPointLL_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LL6),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, node_LatLon),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, regional),
