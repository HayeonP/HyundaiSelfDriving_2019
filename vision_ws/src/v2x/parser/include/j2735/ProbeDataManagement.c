...
static asn_TYPE_member_t asn_MBR_term_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeDataManagement__term, termtime),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeDataManagement__term, termDistance),
...
static asn_TYPE_member_t asn_MBR_snapshot_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeDataManagement__snapshot, snapshotTime),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeDataManagement__snapshot, snapshotDistance),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
