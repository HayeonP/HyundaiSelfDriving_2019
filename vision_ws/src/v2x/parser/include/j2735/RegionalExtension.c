...
static asn_CHOICE_specifics_t asn_SPC_regExtValue_specs_3 = {
	sizeof(struct RegionalExtension_124P0__regExtValue),
	offsetof(struct RegionalExtension_124P0__regExtValue, _asn_ctx),
	offsetof(struct RegionalExtension_124P0__regExtValue, present),
	sizeof(((struct RegionalExtension_124P0__regExtValue *)0)->present),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_RegionalExtension_124P0_1[] = {
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct RegionalExtension_124P0, regExtValue),
