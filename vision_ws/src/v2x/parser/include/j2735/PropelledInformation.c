...
asn_TYPE_member_t asn_MBR_PropelledInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PropelledInformation, human),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PropelledInformation, animal),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PropelledInformation, motor),
