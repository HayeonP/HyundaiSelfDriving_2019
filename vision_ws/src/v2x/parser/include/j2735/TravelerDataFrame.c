...
static asn_TYPE_member_t asn_MBR_msgId_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__msgId, furtherInfoID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__msgId, roadSignID),
...
static asn_TYPE_member_t asn_MBR_content_16[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__content, advisory),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__content, workZone),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_WorkZone,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__content, genericSign),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__content, speedLimit),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame__content, exitService),
