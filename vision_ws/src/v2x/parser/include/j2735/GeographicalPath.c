...
static asn_TYPE_member_t asn_MBR_description_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GeographicalPath__description, path),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GeographicalPath__description, geometry),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GeographicalPath__description, oldRegion),
