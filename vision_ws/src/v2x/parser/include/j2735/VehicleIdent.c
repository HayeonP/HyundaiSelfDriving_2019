...
static asn_TYPE_member_t asn_MBR_vehicleClass_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleIdent__vehicleClass, vGroup),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleIdent__vehicleClass, rGroup),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleIdent__vehicleClass, rEquip),
