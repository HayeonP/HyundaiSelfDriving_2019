...
static asn_TYPE_member_t asn_MBR_area_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ValidRegion__area, shapePointSet),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ValidRegion__area, circle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ValidRegion__area, regionPointSet),
