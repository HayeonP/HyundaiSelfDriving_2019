...
static asn_TYPE_member_t asn_MBR_VerticalOffset_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, offset6),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, elevation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VerticalOffset, regional),
